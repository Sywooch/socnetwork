                    ...
                    f = {
                        ...
                        _filesCheck: function () {
                            ...
                            if (n.limit && f.files.length + f._itFl.length > n.limit) {
                                yii.yii.mes(f._assets.textParse(n.captions.errors.filesLimit), 'error');
                                return false
                            }
                            for (var t = 0; t < f.files.length; t++) {
                                ...
                                if (n.extensions != null && $.inArray(x, n.extensions) == -1) {
                                    yii.mes(f._assets.textParse(n.captions.errors.filesType, m), 'error');
                                    return false;
                                    break
                                }
                                if (n.maxSize != null && f.files[t].size > n.maxSize * 1048576) {
                                    yii.mes(f._assets.textParse(n.captions.errors.filesSize, m), 'error');
                                    return false;
                                    break
                                }
                            ...
                            if (n.maxSize != null && s >= Math.round(n.maxSize * 1048576)) {
                                yii.mes(f._assets.textParse(n.captions.errors.filesSizeAll), 'error');
                                return false
                            }
                            ...
                            _box: function (params) {
                                ...
                                if (l.length < 1) {
                                    ...
                                    l.on('click', n.templates._selectors.remove, function (e) {
                                        e.preventDefault();
                                        var $filer = $(this);
                                        var cf = n.templates.removeConfirmation ? yii.confirm(n.captions.removeConfirmation, function () {
                                            f._remove(params ? params.remove.event : e, params ? params.remove.el : $filer.closest(n.templates._selectors.item));
                                        }) : true;
                                        if (cf) {
